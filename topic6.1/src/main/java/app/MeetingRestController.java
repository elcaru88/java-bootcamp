...
public class MeetingRestController {
	...
	public ArrayList<String> createMeeting(
		...
		//http://localhost:8080/meeting/create?attendee=1&room=2&timeSlot=13:00
	...
	public ArrayList<String> deleteMeeting(@PathVariable long meetingId) throws DataFormatException{
		...
		//if (meetingId != meetingRepository.findByMeetingId(meetingId).getMeetingId()) throw new DataFormatException("ID doesn't match!");
		return listMeeting();
	}
